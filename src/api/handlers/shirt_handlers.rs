...
use crate::{application::ShirtService, domain::entities::Shirt};
...
impl ShirtHandlers {
    pub fn new(service: ShirtService) -> Self {
        Self { service }
    }
}
...
pub async fn create_shirt(
    ...
    match handlers.service.create_shirt(shirt) {
...
pub async fn get_shirt_by_id(
    ...
    match handlers.service.get_shirt_by_id(&id) {
...
pub async fn get_all_shirts(State(handlers): State<ShirtHandlers>) -> impl IntoResponse {
    match handlers.service.get_all_shirts() {
...
pub async fn update_shirt(
    ...
    match handlers.service.update_shirt(&id, shirt) {
...
pub async fn delete_shirt(
    ...
    match handlers.service.delete_shirt(&id) {
